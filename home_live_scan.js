const home_live_scan = {
    template: `
    <div>
        <div class="centered">
            <h2 class ="text-center" style="font-weight: bold; font-size: 20px;">Systeme de Gestion de Parking (Avec Camera Device)</h2>
            ...
            <div  class="container centered">
             ...
             <form class="my-1">
                    <div class="form-group">
                        <input id="autoFocusInput" v-model="qrCode" @input="handleInputChange" autofocus type="text" class="form-control hidden-input" placeholder="Scannez Votre QRCode">
                    </div>
    ...
    methods: {
        handleInputChange() {
            ...
            const enteredValue = this.qrCode;
                        ...
                        if (video.readyState === video.HAVE_ENOUGH_DATA) {
                            ...
                            if (code) {
                               ...
                               // scanQRCode();
                                ...
                                //window.location.href = 'index.html/home_live_scan';
